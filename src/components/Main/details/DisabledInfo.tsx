    ...
    <div className="p-4 space-y-3 bg-white">
      ...
      <div>
        ...
        <div className="flex items-center gap-4 mb-4">
          <h3 className="mb-1 font-semibold">희망 요일/시간</h3>
          <div className="flex flex-wrap gap-2 text-sm">
            <Badge text="월" />
            <Badge text="수" />
            <Badge text="금" />
          </div>
          <p className="text-sm text-black">14:00~18:00</p>
        </div>

        {/* 두번째 줄 */}
        <div className="flex items-center justify-center gap-4 ml-13">
          <div className="flex flex-wrap gap-2 text-sm">
            <Badge text="화" />
            <Badge text="목" />
          </div>
          <p className="text-sm text-black ml-9">15:30~18:30</p>
        </div>
      </div>
